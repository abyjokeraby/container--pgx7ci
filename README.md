...
> Be patient! In ~3 mins your app is live, at your [app url](https://container--pgx7ci.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container--pgx7ci.containers.anotherwebservice.com/
...
```
git clone git@github.com:abyjokeraby/container--pgx7ci.git
cd container--pgx7ci
```
...
```
docker attach container--pgx7ci
```
